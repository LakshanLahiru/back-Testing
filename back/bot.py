...
class data_base_conector:
    ...
    def insert_data(openTime,closeTime,entryPrice,closePrice ,decision,side,profit,ROI):
        try:  
            ...
            sql = "INSERT INTO back (openTime,closeTime,entryPrice,closePrice ,decision,side,profit,ROI ) VALUES (%s,%s,%s,%s,%s,%s,%s,%s)"
...
schedule.every().day.at("00:00:00").do(ob1.update_daily)
